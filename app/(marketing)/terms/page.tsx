...
import { getContactContent, getTermsContent } from "@/lib/keystatic-reader";
                            ...
                            <div className="space-y-8">
                                {terms.sections.map((section) => {
                                    const isContactSection =
                                        section.title.trim().toLowerCase() === "contact";
