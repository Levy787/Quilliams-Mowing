    ...
    return (
        <section className="w-full py-2">
            ...
            <div className="hidden motion-reduce:flex w-full overflow-x-auto px-4 md:px-8 lg:px-16">
                <div className="flex w-max items-baseline gap-x-12 whitespace-nowrap py-2 text-2xl font-extrabold tracking-tight leading-[1.1] md:text-4xl lg:text-5xl">
            ...
            <div className="motion-reduce:hidden w-full overflow-x-hidden px-4 md:px-8 lg:px-16">
                <div
                    aria-hidden="true"
                    className="flex w-max items-baseline gap-x-12 whitespace-nowrap py-2 text-2xl font-extrabold tracking-tight leading-[1.1] md:text-4xl lg:text-5xl animate-marquee"
                >
