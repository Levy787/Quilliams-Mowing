...
export const areas: Record<string, Area> = {
    truro: {
        ...
        geo: { latitude: 50.26320, longitude: -5.05100, radiusMeters: 15000 },
        paragraphs: [
            "I'm Levi Quilliam, a gardener and landscaper based in Trevarrian near Newquay, and Truro is one of the areas I work in most often. Cornwall's only city has a brilliant mix of garden types, from the walled courtyard gardens behind period townhouses on Lemon Street to the bigger plots out towards Treliske and the newer builds going up around Langarth. Each one comes with its own quirks, and that variety is exactly what keeps the work interesting. Whether you need a one-off cleanup to get on top of things or regular maintenance to keep your garden looking sharp year-round, I can help. I carry public liability insurance, and Quilliams is an Environment Agency registered waste carrier (lower tier), CBDL582202. I confirm any waste-removal route in the quote.",
    ...
    bodmin: {
        ...
        geo: { latitude: 50.47130, longitude: -4.72430, radiusMeters: 15000 },
        paragraphs: [
    ...
    padstow: {
        ...
        geo: { latitude: 50.54190, longitude: -4.93670, radiusMeters: 15000 },
        paragraphs: [
        ...
        testimonial: {
            name: "Lucy Jane",
            quote: "Levi did an amazing job with our garden. He got loads more done than we thought would be possible in the time and is a very kind, respectful person.",
            location: "Cornwall",
        },
        services: ["lawn-care", "hedge-trimming", "garden-maintenance", "landscaping"],
    ...
    perranporth: {
        ...
        geo: { latitude: 50.34390, longitude: -5.15530, radiusMeters: 12000 },
        paragraphs: [
            "I'm Levi Quilliam, a gardener and landscaper based in Trevarrian near Newquay, and Perranporth is the closest area I cover outside of my immediate neighbourhood. It's only about 10 to 15 minutes down the road, which means I'm in the area frequently and can often fit jobs in at short notice. Perranporth is known for its three-mile beach and the dramatic dunes that back it, and the village itself spreads up the hillside and out towards Bolingey and Goonhavern. Gardens here range from compact terraced plots close to the village centre to the larger, more exposed properties on the upper slopes with views towards Cligga Head. I offer lawn care, hedge trimming, garden maintenance, clearance work, and landscaping across Perranporth. I carry public liability insurance, and Quilliams is an Environment Agency registered waste carrier (lower tier), CBDL582202.",
    ...
    newquay: {
        ...
        county: "Cornwall",
        description:
            "Local gardener for recurring garden maintenance in Newquay. From nearby Trevarrian, Levi Quilliam provides lawn care, hedge trimming, tidy-ups and practical landscaping with clear, free quotes.",
        geo: { latitude: 50.41550, longitude: -5.07370, radiusMeters: 12000 },
        paragraphs: [
    ...
    "st-agnes": {
        ...
        county: "Cornwall",
        description:
            "Garden maintenance in St Agnes, Cornwall, including reliable lawn care, hedge trimming and seasonal tidy-ups across Mithian, Porthtowan, Peterville and nearby north-coast villages.",
        geo: { latitude: 50.31280, longitude: -5.20410, radiusMeters: 12000 },
        paragraphs: [
            "I provide regular garden maintenance in St Agnes and the surrounding north-coast villages from my base in Trevarrian near Newquay. St Agnes is a former mining village that sits high above Trevaunance Cove, and it has a character that's quite different from anywhere else I work. The village spreads from the older cottages around Churchtown and Peterville towards Mithian and Mingoose. Gardens here are shaped by steep slopes, thin soils and persistent Atlantic wind. I offer lawn mowing, hedge trimming, recurring maintenance and seasonal clearances across St Agnes. I carry public liability insurance, and Quilliams is an Environment Agency registered waste carrier (lower tier), CBDL582202.",
        ...
        testimonial: {
            name: "Evie Pratt",
            quote: "Fantastic job transforming our garden. The weeds had become completely overgrown and out of hand. We're extremely pleased with the results and would highly recommend to anyone needing garden work done.",
            location: "Cornwall",
        },
        services: ["lawn-care", "hedge-trimming", "garden-maintenance", "seasonal-cleanup"],
