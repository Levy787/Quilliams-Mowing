...
export const areas: Record<string, Area> = {
    truro: {
        ...
        paragraphs: [
            "I'm Levi Quilliam, a gardener and landscaper based in Trevarrian near Newquay, and Truro is one of the areas I work in most often. Cornwall's only city has a brilliant mix of garden types, from the walled courtyard gardens behind period townhouses on Lemon Street to the bigger plots out towards Treliske and the newer builds going up around Langarth. Each one comes with its own quirks, and that variety is exactly what keeps the work interesting. Whether you need a one-off cleanup to get on top of things or regular maintenance to keep your garden looking sharp year-round, I can help. I carry public liability insurance and I'm a licensed waste carrier, so everything from the first cut to the final bag of green waste is handled properly.",
