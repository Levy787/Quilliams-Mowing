...
export function StickyMobileCTA() {
    ...
    return (
        <>
            ...
            {visible && <div className="h-[64px] md:hidden" aria-hidden="true" />}
                ...
                <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-background border-t shadow-lg safe-area-inset-bottom">
                    <div className="flex">
                        <a
                            ...
                            className="flex-1 flex min-h-12 items-center justify-center gap-2 py-4 bg-muted hover:bg-muted/80 transition-colors"
                            onClick={() => {
                        ...
                        <Link
                            href="/quote"
                            className="flex-1 flex min-h-12 items-center justify-center gap-2 py-4 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
